 ...
 */
	...
	app.post("/addFood", function(req, res, next) {
		...
		publishMsgToRobotapplication( "addFood", food  );
  		next();
 	});		
	app.post("/exposeFridge", function(req, res, next) {
		publishEmitEvent( "exposeFood","exposeFood" );
  		next();
 	});		
...
var publishMsgToRobotapplication = function ( cmd ){
   	var msgstr = "msg(" + cmd +",dispatch,js,robotmindapplication,(" + cmd +"),1)"  ;  //TODO: replace 1 with counter
...
//Towards the butler application
   	var msgstr = "msg(cmd,dispatch,js,butler_solver,cmd(" + cmd + ", _ ),1)"  ;  //TODO: replace 1 with counter
  	console.log("publishMsgToRobotapplication forward> "+ msgstr);
   	mqttUtils.publish( msgstr, "unibo/qak/butler_solver" );
}

var publishMsgToRobotapplication = function (cmd , arg = "null" ){
   	var msgstr = "msg(" + cmd + ",dispatch,js,robotmindapplication,"+ cmd +"("+arg+"),1)"  ;  //TODO: replace 1 with counter
  	console.log("publishMsgToRobotapplication forward> "+ msgstr);
   	mqttUtils.publish( msgstr, "unibo/qak/robotmindapplication" );
//Towards the butler application
   	var msgstr = "msg(cmd,dispatch,js,butler_solver,cmd(" + cmd + "," + arg + " ),1)"  ;  //TODO: replace 1 with counter
  	console.log("publishMsgToRobotapplication forward> "+ msgstr);
   	mqttUtils.publish( msgstr, "unibo/qak/butler_solver" );
}
